...
NAMES = {
    ...
    'Владимир': {
        'gender': 'masc',
        'variants': ['Володимир'],
        'diminutives': ['Вова', 'Вовка', 'Вовочка', 'Володя'],
    ...
    'Александр': {
        'gender': 'masc',
        'variants': ['Олександр'],
        'diminutives': ['Саша', 'Сашенька', 'Шура', 'Саня', 'Алекс'],
    ...
    'Дмитрий': {
        'gender': 'masc',
        'variants': ['Дмитро'],
        'diminutives': ['Дима', 'Димочка', 'Митя', 'Димон'],
    ...
    'Дмитрий': {
        'gender': 'masc',
        'variants': ['Дмитрій'],
        'diminutives': ['Дима', 'Димочка', 'Димка'],
    ...
    'Александр': {
        'gender': 'masc',
        'variants': ['Олександр'],
        'diminutives': ['Саша', 'Сашенька', 'Шура'],
        'transliterations': ['Aleksandr', 'Oleksandr', 'Sasha'],
        'declensions': ['Александра', 'Александру', 'Александра', 'Александром', 'Александре']
    },
    'Артём': {
